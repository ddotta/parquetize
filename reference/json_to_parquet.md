...
#> Reading data...
#> Writing data...
#> ✔ Data are available in parquet file under /tmp/Rtmp5JozyA/file1951528454d4.parquet
#> Writing data...
#> Reading data...
...
#> Reading data...
#> Writing data...
#> ✔ Data are available in parquet file under /tmp/Rtmp5JozyA/file1951171e86dc.parquet
#> Writing data...
#> Reading data...
```
