...
#> Reading data...
#> Writing data...
#> ✔ Data are available in parquet file under /tmp/Rtmp6AeROy/file18ce419aaa46.parquet
#> Writing data...
#> Reading data...
...
#> Reading data...
#> Writing data...
#> ✔ Data are available in parquet file under /tmp/Rtmp6AeROy/file18ce5bb48411.parquet
#> Writing data...
#> Reading data...
...
#> Reading data...
#> Writing data...
#> ✔ Data are available in parquet file under /tmp/Rtmp6AeROy/file18ce31fe5a44.parquet
#> Writing data...
#> Reading data...
```
