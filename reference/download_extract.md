...
#> Reading data...
#> Writing data...
#> ✔ Data are available in parquet file under /tmp/Rtmp5JozyA/file195115fdce6a.parquet
#> Writing data...
#> Reading data...
...
#> Reading data...
#> Writing data...
#> ✔ Data are available in parquet file under /tmp/Rtmp5JozyA/file19515088c965.parquet
#> Writing data...
#> Reading data...
...
#> Reading data...
#> Writing data...
#> ✔ Data are available in parquet file under /tmp/Rtmp5JozyA/file1951158a257b.parquet
#> Writing data...
#> Reading data...
```
