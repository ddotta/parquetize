...
#> Reading data...
#> Writing data...
#> ✔ Data are available in parquet file under /tmp/Rtmp5JozyA/file19512a2a2be9.parquet
#> Writing data...
#> Reading data...
...
#> Reading data...
#> Writing data...
#> ✔ Data are available in parquet file under /tmp/Rtmp5JozyA/file19514fd10a2d.parquet
#> Writing data...
#> Reading data...
...
#> Reading data...
#> Writing data...
#> ✔ Data are available in parquet file under /tmp/Rtmp5JozyA/file19517748a216.parquet
#> Writing data...
#> Reading data...
...
#> Reading data...
#> Writing data...
#> ✔ Data are available in parquet dataset under /tmp/Rtmp5JozyA/file19513760ded0.parquet
#> Writing data...
#> Reading data...
...
#> Reading data...
#> Writing data...
#> ✔ Data are available in parquet file under /tmp/Rtmp5JozyA/file19514aada5eb.parquet
#> Writing data...
#> Reading data...
