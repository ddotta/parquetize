...
#> Reading data...
#> Writing data...
#> ✔ Data are available in parquet file under /tmp/Rtmp6AeROy/file18ce6c9e5e7c.parquet
#> Writing data...
#> Reading data...
...
#> ✔ Parquet dataset is available under /tmp/Rtmp6AeROy/
#> Writing data in part-127-150.parquet...
...
#> ✔ Parquet dataset is available under /tmp/Rtmp6AeROy/iris/Species=setosa/
#> Writing data in part-32-50.parquet...
#> Reading data...
#> Writing data in part-1-31.parquet...
#> Reading data...
#> Writing data in part-32-50.parquet...
#> ✔ Parquet dataset is available under /tmp/Rtmp6AeROy/iris/Species=versicolor/
#> Writing data in part-32-50.parquet...
#> Reading data...
#> Writing data in part-1-31.parquet...
#> Reading data...
#> Writing data in part-32-50.parquet...
#> ✔ Parquet dataset is available under /tmp/Rtmp6AeROy/iris/Species=virginica/
#> Writing data in part-32-50.parquet...
