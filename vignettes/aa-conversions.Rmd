...
# Convert huge input file to parquet format with `parquetize`
...
In real life, we can perform this kind of request with the parquetize API (for example with a SAS file of 50 000 000 lines) :  
