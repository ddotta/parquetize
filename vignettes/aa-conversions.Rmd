...
**The idea is to split the very large table into "chunks" based on memory consuption of input data or on the number of rows in the table in order to be able to simultaneously :**  
...
tibble. In this example we get 2 parquet files of 89 lines called
`iris1-89.parquet` and `iris90-178.parquet`
